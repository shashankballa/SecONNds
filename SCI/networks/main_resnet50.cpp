...
uint64_t num_trips = 1 << 28;
uint64_t trips_csize = 1 << 10;
int _snn = 0;
...
void Conv2DReshapeInput(int64_t N, int64_t H, int64_t W, int64_t CI, int64_t FH,
  ...
  for (uint64_t n = 0; n < N; n++) {
    ...
    while (
           (((leftTopCornerH + FH) - 1) <= extremeRightBottomCornerH)) {

      int64_t leftTopCornerW = (0 - zPadWLeft);

      int64_t extremeRightBottomCornerW = ((W - 1) + zPadWRight);
      while (
             (((leftTopCornerW + FW) - 1) <= extremeRightBottomCornerW)) {
        for (uint64_t fh = 0; fh < FH; fh++) {
          for (uint64_t fw = 0; fw < FW; fw++) {
...
void Conv2D(int64_t N, int64_t H, int64_t W, int64_t CI, int64_t FH, int64_t FW,
  ...
  int64_t newH =
    ((((H + (zPadHLeft + zPadHRight)) - FH) / strideH) + 1);

  int64_t newW =
    ((((W + (zPadWLeft + zPadWRight)) - FW) / strideW) + 1);
...
void Conv2DLoop(int64_t N, int64_t H, int64_t W, int64_t CI, int64_t FH,
  ...
  int64_t outH =
    ((((H - FH) + (zPadHLeft + zPadHRight)) / strideH) + 1);

  int64_t outW =
    ((((W - FW) + (zPadWLeft + zPadWRight)) / strideW) + 1);
...
void Conv3DReshapeInput(int64_t N, int64_t D, int64_t H, int64_t W, int64_t CI,
  ...
  for (uint64_t n = 0; n < N; n++) {
    ...
    while (
           (((leftTopCornerD + FD) - 1) <= extremeRightBottomCornerD)) {
...
void Conv3D(int64_t N, int64_t D, int64_t H, int64_t W, int64_t CI, int64_t FD,
  ...
  int64_t newD =
    ((((D + (zPadDLeft + zPadDRight)) - FD) / strideD) + 1);
...
void Conv3DLoop(int64_t N, int64_t D, int64_t H, int64_t W, int64_t CI,
  ...
  int64_t outD =
    ((((D - FD) + (zPadDLeft + zPadDRight)) / strideD) + 1);
...
void ConvTranspose2DReshapeInput(int64_t N, int64_t HPrime, int64_t WPrime,
  ...
  for (uint64_t n = 0; n < N; n++) {
    ...
    int64_t HPrimeTilde =
      (HPrime + ((HPrime - 1) * (strideH - 1)));

    int64_t extremeRightBottomCornerH =
      ((HPrimeTilde - 1) + zPadTrHRight);
    while (
           (((leftTopCornerH + FH) - 1) <= extremeRightBottomCornerH)) {
      ...
      int64_t WPrimeTilde =
        (WPrime + ((WPrime - 1) * (strideW - 1)));

      int64_t extremeRightBottomCornerW =
        ((WPrimeTilde - 1) + zPadTrWRight);
      while (
             (((leftTopCornerW + FW) - 1) <= extremeRightBottomCornerW)) {
        for (uint64_t fh = 0; fh < FH; fh++) {
          for (uint64_t fw = 0; fw < FW; fw++) {
...
void ConvTranspose3DReshapeInput(int64_t N, int64_t DPrime, int64_t HPrime,
  ...
  for (uint64_t n = 0; n < N; n++) {
    ...
    int64_t DPrimeTilde =
      (DPrime + ((DPrime - 1) * (strideD - 1)));

    int64_t extremeRightBottomCornerD =
      ((DPrimeTilde - 1) + zPadTrDRight);
    while (
           (((leftTopCornerD + FD) - 1) <= extremeRightBottomCornerD)) {
...
void Pad442(int64_t s1, int64_t s2, int64_t s3, int64_t s4, int64_t inps1,
  ...
  int64_t lbounds1 =
    Arr2DIdxRowM(paddings, pads1, pads2, 0, 0);

  int64_t rbounds1excl =
    (s1 - Arr2DIdxRowM(paddings, pads1, pads2, 0, 1));

  int64_t lbounds2 =
    Arr2DIdxRowM(paddings, pads1, pads2, 1, 0);

  int64_t rbounds2excl =
    (s2 - Arr2DIdxRowM(paddings, pads1, pads2, 1, 1));

  int64_t lbounds3 =
    Arr2DIdxRowM(paddings, pads1, pads2, 2, 0);

  int64_t rbounds3excl =
    (s3 - Arr2DIdxRowM(paddings, pads1, pads2, 2, 1));

  int64_t lbounds4 =
    Arr2DIdxRowM(paddings, pads1, pads2, 3, 0);

  int64_t rbounds4excl =
    (s4 - Arr2DIdxRowM(paddings, pads1, pads2, 3, 1));
  for (uint64_t i = 0; i < s1; i++) {
    for (uint64_t j = 0; j < s2; j++) {
      for (uint64_t k = 0; k < s3; k++) {
        for (uint64_t l = 0; l < s4; l++) {
...
void Pad552(int64_t s1, int64_t s2, int64_t s3, int64_t s4, int64_t s5,
  ...
  int64_t lbounds5 =
    Arr2DIdxRowM(paddings, pads1, pads2, 4, 0);

  int64_t rbounds5excl =
    (s5 - Arr2DIdxRowM(paddings, pads1, pads2, 4, 1));
  for (uint64_t i = 0; i < s1; i++) {
    for (uint64_t j = 0; j < s2; j++) {
      for (uint64_t k = 0; k < s3; k++) {
        for (uint64_t l = 0; l < s4; l++) {
          ...
          if (((((((((i >= lbounds1) && (i < rbounds1excl)) &&
            ...
            Arr4DIdxRowM(outArr, o1, o2, o3, o4, i, j, k, l) =
              Arr4DIdxRowM(inpArr, i1, i2, i3, i4,
                           (i - Arr1DIdxRowM(paddings, pads, 0)),
...
int main(int argc, char **argv) {
  ...
  uint64_t *tmp0 =
      make_array<uint64_t>(1, 224, 224, 3);
  ...
  uint64_t *tmp6 =
      make_array<uint64_t>(1, 1, 64, 256);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 64; i0++) {
    ...
    Arr1DIdxRowM(tmp11, 64, i0) =
        (party == SERVER) ? __tmp_in_tmp11 : 0;
  }

  uint64_t *tmp12 =
      make_array<uint64_t>(3, 3, 64, 64);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 256; i0++) {
    ...
    Arr1DIdxRowM(tmp21, 256, i0) =
        (party == SERVER) ? __tmp_in_tmp21 : 0;
  }

  uint64_t *tmp22 =
      make_array<uint64_t>(1, 1, 256, 64);
  ...
  uint64_t *tmp53 =
      make_array<uint64_t>(1, 1, 256, 128);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 128; i0++) {
    ...
    Arr1DIdxRowM(tmp57, 128, i0) =
        (party == SERVER) ? __tmp_in_tmp57 : 0;
  }

  uint64_t *tmp58 =
      make_array<uint64_t>(3, 3, 128, 128);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 128; i0++) {
    ...
    Arr1DIdxRowM(tmp62, 128, i0) =
        (party == SERVER) ? __tmp_in_tmp62 : 0;
  }

  uint64_t *tmp63 =
      make_array<uint64_t>(1, 1, 128, 512);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 512; i0++) {
    ...
    Arr1DIdxRowM(tmp67, 512, i0) =
        (party == SERVER) ? __tmp_in_tmp67 : 0;
  }

  uint64_t *tmp68 =
      make_array<uint64_t>(1, 1, 512, 128);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 512; i0++) {
    ...
    Arr1DIdxRowM(tmp112, 512, i0) =
        (party == SERVER) ? __tmp_in_tmp112 : 0;
  }

  uint64_t *tmp113 =
      make_array<uint64_t>(1, 1, 512, 1024);
  ...
  uint64_t *tmp114 =
      make_array<uint64_t>(1, 1, 512, 256);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 256; i0++) {
    ...
    Arr1DIdxRowM(tmp118, 256, i0) =
        (party == SERVER) ? __tmp_in_tmp118 : 0;
  }

  uint64_t *tmp119 =
      make_array<uint64_t>(3, 3, 256, 256);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 256; i0++) {
    ...
    Arr1DIdxRowM(tmp123, 256, i0) =
        (party == SERVER) ? __tmp_in_tmp123 : 0;
  }

  uint64_t *tmp124 =
      make_array<uint64_t>(1, 1, 256, 1024);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 1024; i0++) {
    ...
    Arr1DIdxRowM(tmp128, 1024, i0) =
        (party == SERVER) ? __tmp_in_tmp128 : 0;
  }

  uint64_t *tmp129 =
      make_array<uint64_t>(1, 1, 1024, 256);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 1024; i0++) {
    ...
    Arr1DIdxRowM(tmp203, 1024, i0) =
        (party == SERVER) ? __tmp_in_tmp203 : 0;
  }

  uint64_t *tmp204 = make_array<uint64_t>(1, 1, 1024,
                                          2048);
  ...
  uint64_t *tmp205 =
      make_array<uint64_t>(1, 1, 1024, 512);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 512; i0++) {
    ...
    Arr1DIdxRowM(tmp209, 512, i0) =
        (party == SERVER) ? __tmp_in_tmp209 : 0;
  }

  uint64_t *tmp210 =
      make_array<uint64_t>(3, 3, 512, 512);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 512; i0++) {
    ...
    Arr1DIdxRowM(tmp214, 512, i0) =
        (party == SERVER) ? __tmp_in_tmp214 : 0;
  }

  uint64_t *tmp215 =
      make_array<uint64_t>(1, 1, 512, 2048);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 2048; i0++) {
    ...
    Arr1DIdxRowM(tmp219, 2048, i0) =
        (party == SERVER) ? __tmp_in_tmp219 : 0;
  }

  uint64_t *tmp220 =
      make_array<uint64_t>(1, 1, 2048, 512);
  ...
  for (uint64_t i0 = (uint64_t)0; i0 < 1001; i0++) {
    ...
    Arr1DIdxRowM(tmp251, 1001, i0) =
        (party == SERVER) ? __tmp_in_tmp251 : 0;
  }

  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_1;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_6;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_7;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_12;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_17;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_22;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_27;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_32;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_37;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_42;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_47;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_52;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_53;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_58;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_63;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_68;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_73;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_78;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_83;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_88;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_93;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_98;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_103;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_108;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_113;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_114;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_119;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_124;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_129;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_134;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_139;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_144;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_149;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_154;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_159;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_164;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_169;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_174;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_179;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_184;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_189;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_194;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_199;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_204;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_205;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_210;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_215;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_220;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_225;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_230;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_235;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_240;
  vector<vector<vector<vector<uint64_t>>>> secret_share_vec_245;

  vector<vector<vector<seal::Ciphertext>>> noise_cts_1;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_6;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_7;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_12;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_17;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_22;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_27;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_32;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_37;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_42;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_47;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_52;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_53;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_58;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_63;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_68;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_73;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_78;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_83;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_88;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_93;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_98;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_103;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_108;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_113;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_114;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_119;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_124;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_129;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_134;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_139;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_144;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_149;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_154;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_159;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_164;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_169;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_174;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_179;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_184;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_189;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_194;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_199;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_204;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_205;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_210;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_215;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_220;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_225;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_230;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_235;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_240;
  vector<vector<vector<seal::Ciphertext>>> noise_cts_245;

  vector<vector<vector<seal::Plaintext>>> noise_pts_1;
  vector<vector<vector<seal::Plaintext>>> noise_pts_6;
  vector<vector<vector<seal::Plaintext>>> noise_pts_7;
  vector<vector<vector<seal::Plaintext>>> noise_pts_12;
  vector<vector<vector<seal::Plaintext>>> noise_pts_17;
  vector<vector<vector<seal::Plaintext>>> noise_pts_22;
  vector<vector<vector<seal::Plaintext>>> noise_pts_27;
  vector<vector<vector<seal::Plaintext>>> noise_pts_32;
  vector<vector<vector<seal::Plaintext>>> noise_pts_37;
  vector<vector<vector<seal::Plaintext>>> noise_pts_42;
  vector<vector<vector<seal::Plaintext>>> noise_pts_47;
  vector<vector<vector<seal::Plaintext>>> noise_pts_52;
  vector<vector<vector<seal::Plaintext>>> noise_pts_53;
  vector<vector<vector<seal::Plaintext>>> noise_pts_58;
  vector<vector<vector<seal::Plaintext>>> noise_pts_63;
  vector<vector<vector<seal::Plaintext>>> noise_pts_68;
  vector<vector<vector<seal::Plaintext>>> noise_pts_73;
  vector<vector<vector<seal::Plaintext>>> noise_pts_78;
  vector<vector<vector<seal::Plaintext>>> noise_pts_83;
  vector<vector<vector<seal::Plaintext>>> noise_pts_88;
  vector<vector<vector<seal::Plaintext>>> noise_pts_93;
  vector<vector<vector<seal::Plaintext>>> noise_pts_98;
  vector<vector<vector<seal::Plaintext>>> noise_pts_103;
  vector<vector<vector<seal::Plaintext>>> noise_pts_108;
  vector<vector<vector<seal::Plaintext>>> noise_pts_113;
  vector<vector<vector<seal::Plaintext>>> noise_pts_114;
  vector<vector<vector<seal::Plaintext>>> noise_pts_119;
  vector<vector<vector<seal::Plaintext>>> noise_pts_124;
  vector<vector<vector<seal::Plaintext>>> noise_pts_129;
  vector<vector<vector<seal::Plaintext>>> noise_pts_134;
  vector<vector<vector<seal::Plaintext>>> noise_pts_139;
  vector<vector<vector<seal::Plaintext>>> noise_pts_144;
  vector<vector<vector<seal::Plaintext>>> noise_pts_149;
  vector<vector<vector<seal::Plaintext>>> noise_pts_154;
  vector<vector<vector<seal::Plaintext>>> noise_pts_159;
  vector<vector<vector<seal::Plaintext>>> noise_pts_164;
  vector<vector<vector<seal::Plaintext>>> noise_pts_169;
  vector<vector<vector<seal::Plaintext>>> noise_pts_174;
  vector<vector<vector<seal::Plaintext>>> noise_pts_179;
  vector<vector<vector<seal::Plaintext>>> noise_pts_184;
  vector<vector<vector<seal::Plaintext>>> noise_pts_189;
  vector<vector<vector<seal::Plaintext>>> noise_pts_194;
  vector<vector<vector<seal::Plaintext>>> noise_pts_199;
  vector<vector<vector<seal::Plaintext>>> noise_pts_204;
  vector<vector<vector<seal::Plaintext>>> noise_pts_205;
  vector<vector<vector<seal::Plaintext>>> noise_pts_210;
  vector<vector<vector<seal::Plaintext>>> noise_pts_215;
  vector<vector<vector<seal::Plaintext>>> noise_pts_220;
  vector<vector<vector<seal::Plaintext>>> noise_pts_225;
  vector<vector<vector<seal::Plaintext>>> noise_pts_230;
  vector<vector<vector<seal::Plaintext>>> noise_pts_235;
  vector<vector<vector<seal::Plaintext>>> noise_pts_240;
  vector<vector<vector<seal::Plaintext>>> noise_pts_245;

  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp1_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp6_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp7_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp12_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp17_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp22_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp27_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp32_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp37_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp42_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp47_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp52_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp53_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp58_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp63_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp68_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp73_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp78_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp83_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp88_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp93_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp98_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp103_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp108_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp113_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp114_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp119_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp124_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp129_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp134_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp139_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp144_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp149_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp154_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp159_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp164_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp169_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp174_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp179_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp184_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp189_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp194_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp199_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp204_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp205_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp210_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp215_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp220_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp225_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp230_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp235_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp240_pts;
  vector<vector<vector<vector<vector<seal::Plaintext>>>>> tmp245_pts;

  ConnectAndSetUp(use_seconnds);
  if(use_seconnds && (party == SERVER)){
    ConvOfflineHeliks(conv_ntt, 1, 230, 230, 3, 7, 7, 64, 0, 0, 0, 0, 2, 2, tmp1, noise_cts_1, noise_pts_1, secret_share_vec_1, tmp1_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 64, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp6, noise_cts_6, noise_pts_6, secret_share_vec_6, tmp6_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 64, 1, 1, 64, 0, 0, 0, 0, 1, 1, tmp7, noise_cts_7, noise_pts_7, secret_share_vec_7, tmp7_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 64, 3, 3, 64, 1, 1, 1, 1, 1, 1, tmp12, noise_cts_12, noise_pts_12, secret_share_vec_12, tmp12_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 64, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp17, noise_cts_17, noise_pts_17, secret_share_vec_17, tmp17_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 256, 1, 1, 64, 0, 0, 0, 0, 1, 1, tmp22, noise_cts_22, noise_pts_22, secret_share_vec_22, tmp22_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 64, 3, 3, 64, 1, 1, 1, 1, 1, 1, tmp27, noise_cts_27, noise_pts_27, secret_share_vec_27, tmp27_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 64, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp32, noise_cts_32, noise_pts_32, secret_share_vec_32, tmp32_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 256, 1, 1, 64, 0, 0, 0, 0, 1, 1, tmp37, noise_cts_37, noise_pts_37, secret_share_vec_37, tmp37_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 64, 3, 3, 64, 1, 1, 1, 1, 1, 1, tmp42, noise_cts_42, noise_pts_42, secret_share_vec_42, tmp42_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 64, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp47, noise_cts_47, noise_pts_47, secret_share_vec_47, tmp47_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 256, 1, 1, 512, 0, 0, 0, 0, 2, 2, tmp52, noise_cts_52, noise_pts_52, secret_share_vec_52, tmp52_pts);
    ConvOfflineHeliks(conv_ntt, 1, 56, 56, 256, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp53, noise_cts_53, noise_pts_53, secret_share_vec_53, tmp53_pts);
    ConvOfflineHeliks(conv_ntt, 1, 58, 58, 128, 3, 3, 128, 0, 0, 0, 0, 2, 2, tmp58, noise_cts_58, noise_pts_58, secret_share_vec_58, tmp58_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 128, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp63, noise_cts_63, noise_pts_63, secret_share_vec_63, tmp63_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 512, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp68, noise_cts_68, noise_pts_68, secret_share_vec_68, tmp68_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 128, 3, 3, 128, 1, 1, 1, 1, 1, 1, tmp73, noise_cts_73, noise_pts_73, secret_share_vec_73, tmp73_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 128, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp78, noise_cts_78, noise_pts_78, secret_share_vec_78, tmp78_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 512, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp83, noise_cts_83, noise_pts_83, secret_share_vec_83, tmp83_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 128, 3, 3, 128, 1, 1, 1, 1, 1, 1, tmp88, noise_cts_88, noise_pts_88, secret_share_vec_88, tmp88_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 128, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp93, noise_cts_93, noise_pts_93, secret_share_vec_93, tmp93_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 512, 1, 1, 128, 0, 0, 0, 0, 1, 1, tmp98, noise_cts_98, noise_pts_98, secret_share_vec_98, tmp98_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 128, 3, 3, 128, 1, 1, 1, 1, 1, 1, tmp103, noise_cts_103, noise_pts_103, secret_share_vec_103, tmp103_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 128, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp108, noise_cts_108, noise_pts_108, secret_share_vec_108, tmp108_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 512, 1, 1, 1024, 0, 0, 0, 0, 2, 2, tmp113, noise_cts_113, noise_pts_113, secret_share_vec_113, tmp113_pts);
    ConvOfflineHeliks(conv_ntt, 1, 28, 28, 512, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp114, noise_cts_114, noise_pts_114, secret_share_vec_114, tmp114_pts);
    ConvOfflineHeliks(conv_ntt, 1, 30, 30, 256, 3, 3, 256, 0, 0, 0, 0, 2, 2, tmp119, noise_cts_119, noise_pts_119, secret_share_vec_119, tmp119_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 1, 1, 1024, 0, 0, 0, 0, 1, 1, tmp124, noise_cts_124, noise_pts_124, secret_share_vec_124, tmp124_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp129, noise_cts_129, noise_pts_129, secret_share_vec_129, tmp129_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 3, 3, 256, 1, 1, 1, 1, 1, 1, tmp134, noise_cts_134, noise_pts_134, secret_share_vec_134, tmp134_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 1, 1, 1024, 0, 0, 0, 0, 1, 1, tmp139, noise_cts_139, noise_pts_139, secret_share_vec_139, tmp139_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp144, noise_cts_144, noise_pts_144, secret_share_vec_144, tmp144_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 3, 3, 256, 1, 1, 1, 1, 1, 1, tmp149, noise_cts_149, noise_pts_149, secret_share_vec_149, tmp149_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 1, 1, 1024, 0, 0, 0, 0, 1, 1, tmp154, noise_cts_154, noise_pts_154, secret_share_vec_154, tmp154_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp159, noise_cts_159, noise_pts_159, secret_share_vec_159, tmp159_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 3, 3, 256, 1, 1, 1, 1, 1, 1, tmp164, noise_cts_164, noise_pts_164, secret_share_vec_164, tmp164_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 1, 1, 1024, 0, 0, 0, 0, 1, 1, tmp169, noise_cts_169, noise_pts_169, secret_share_vec_169, tmp169_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp174, noise_cts_174, noise_pts_174, secret_share_vec_174, tmp174_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 3, 3, 256, 1, 1, 1, 1, 1, 1, tmp179, noise_cts_179, noise_pts_179, secret_share_vec_179, tmp179_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 1, 1, 1024, 0, 0, 0, 0, 1, 1, tmp184, noise_cts_184, noise_pts_184, secret_share_vec_184, tmp184_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 1024, 1, 1, 256, 0, 0, 0, 0, 1, 1, tmp189, noise_cts_189, noise_pts_189, secret_share_vec_189, tmp189_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 3, 3, 256, 1, 1, 1, 1, 1, 1, tmp194, noise_cts_194, noise_pts_194, secret_share_vec_194, tmp194_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 256, 1, 1, 1024, 0, 0, 0, 0, 1, 1, tmp199, noise_cts_199, noise_pts_199, secret_share_vec_199, tmp199_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 1024, 1, 1, 2048, 0, 0, 0, 0, 2, 2, tmp204, noise_cts_204, noise_pts_204, secret_share_vec_204, tmp204_pts);
    ConvOfflineHeliks(conv_ntt, 1, 14, 14, 1024, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp205, noise_cts_205, noise_pts_205, secret_share_vec_205, tmp205_pts);
    ConvOfflineHeliks(conv_ntt, 1, 16, 16, 512, 3, 3, 512, 0, 0, 0, 0, 2, 2, tmp210, noise_cts_210, noise_pts_210, secret_share_vec_210, tmp210_pts);
    ConvOfflineHeliks(conv_ntt, 1, 7, 7, 512, 1, 1, 2048, 0, 0, 0, 0, 1, 1, tmp215, noise_cts_215, noise_pts_215, secret_share_vec_215, tmp215_pts);
    ConvOfflineHeliks(conv_ntt, 1, 7, 7, 2048, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp220, noise_cts_220, noise_pts_220, secret_share_vec_220, tmp220_pts);
    ConvOfflineHeliks(conv_ntt, 1, 7, 7, 512, 3, 3, 512, 1, 1, 1, 1, 1, 1, tmp225, noise_cts_225, noise_pts_225, secret_share_vec_225, tmp225_pts);
    ConvOfflineHeliks(conv_ntt, 1, 7, 7, 512, 1, 1, 2048, 0, 0, 0, 0, 1, 1, tmp230, noise_cts_230, noise_pts_230, secret_share_vec_230, tmp230_pts);
    ConvOfflineHeliks(conv_ntt, 1, 7, 7, 2048, 1, 1, 512, 0, 0, 0, 0, 1, 1, tmp235, noise_cts_235, noise_pts_235, secret_share_vec_235, tmp235_pts);
    ConvOfflineHeliks(conv_ntt, 1, 7, 7, 512, 3, 3, 512, 1, 1, 1, 1, 1, 1, tmp240, noise_cts_240, noise_pts_240, secret_share_vec_240, tmp240_pts);
  ...
  StartComputation(use_seconnds, mill_low_rnd);
  ...
  Arr2DIdxRowM(tmp252, 4, 2, (int64_t)0, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp252, 4, 2, (int64_t)0, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp252, 4, 2, (int64_t)1, (int64_t)0) =
      3;
  Arr2DIdxRowM(tmp252, 4, 2, (int64_t)1, (int64_t)1) =
      3;
  Arr2DIdxRowM(tmp252, 4, 2, (int64_t)2, (int64_t)0) =
      3;
  Arr2DIdxRowM(tmp252, 4, 2, (int64_t)2, (int64_t)1) =
      3;
  Arr2DIdxRowM(tmp252, 4, 2, (int64_t)3, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp252, 4, 2, (int64_t)3, (int64_t)1) =
      0;

  uint64_t *tmp253 =
      make_array<uint64_t>(1, 230, 230, 3);
  Pad442(1, 230, 230, 3, 1,
         224, 224, 3, tmp0, 4, 2,
         tmp252, tmp253);
  ...
  uint64_t *tmp256 =
      make_array<uint64_t>(1, 112, 112, 64);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,230,230,3,7,7,64,0,0,0,0,2,2,tmp253,tmp1,noise_cts_1,noise_pts_1,secret_share_vec_1,tmp1_pts,tmp256);
	}
  ...
  uint64_t *tmp259 =
      make_array<uint64_t>(1, 56, 56, 64);
  MaxPool(1, 56, 56, 64, 3,
          3, 0, 1, 0, 1,
          2, 2, 1, 112, 112,
          64, tmp256, tmp259);
  ...
  uint64_t *tmp265 =
      make_array<uint64_t>(1, 56, 56, 64);
  Relu4(1, 56, 56, 64, tmp261, tmp265,
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,64,1,1,256,0,0,0,0,1,1,tmp265,tmp6,noise_cts_6,noise_pts_6,secret_share_vec_6,tmp6_pts,tmp267);
	}
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,64,1,1,64,0,0,0,0,1,1,tmp265,tmp7,noise_cts_7,noise_pts_7,secret_share_vec_7,tmp7_pts,tmp269);
	}
  ...
  uint64_t *tmp272 =
      make_array<uint64_t>(1, 56, 56, 64);
  ScaleDown4(1, 56, 56, 64, tmp269,
             12);
  FusedBatchNorm4411(1, 56, 56, 64, tmp269,
                     tmp8, tmp9, 0, kScale, tmp272);
  ...
  uint64_t *tmp276 =
      make_array<uint64_t>(1, 56, 56, 64);
  Relu4(1, 56, 56, 64, tmp272, tmp276,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,64,3,3,64,1,1,1,1,1,1,tmp276,tmp12,noise_cts_12,noise_pts_12,secret_share_vec_12,tmp12_pts,tmp278);
	}
  ...
  uint64_t *tmp281 =
      make_array<uint64_t>(1, 56, 56, 64);
  ScaleDown4(1, 56, 56, 64, tmp278,
             12);
  FusedBatchNorm4411(1, 56, 56, 64, tmp278,
                     tmp13, tmp14, 0, kScale, tmp281);
  ...
  uint64_t *tmp285 =
      make_array<uint64_t>(1, 56, 56, 64);
  Relu4(1, 56, 56, 64, tmp281, tmp285,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,64,1,1,256,0,0,0,0,1,1,tmp285,tmp17,noise_cts_17,noise_pts_17,secret_share_vec_17,tmp17_pts,tmp287);
	}
  ...
  uint64_t *tmp290 =
      make_array<uint64_t>(1, 56, 56, 256);
  MatAdd4(1, 56, 56, 256, tmp287, tmp267,
          tmp290);
  ...
  uint64_t *tmp293 =
      make_array<uint64_t>(1, 56, 56, 256);
  ScaleDown4(1, 56, 56, 256, tmp290,
             12);
  FusedBatchNorm4411(1, 56, 56, 256, tmp290,
                     tmp18, tmp19, 0, kScale, tmp293);
  ClearMemSecret1(256, tmp18);
  ClearMemSecret1(256, tmp19);

  uint64_t *tmp296 =
      make_array<uint64_t>(1, 56, 56, 256);
  Relu4(1, 56, 56, 256, tmp293, tmp296,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,256,1,1,64,0,0,0,0,1,1,tmp296,tmp22,noise_cts_22,noise_pts_22,secret_share_vec_22,tmp22_pts,tmp298);
	}
  ...
  uint64_t *tmp301 =
      make_array<uint64_t>(1, 56, 56, 64);
  ScaleDown4(1, 56, 56, 64, tmp298,
             12);
  FusedBatchNorm4411(1, 56, 56, 64, tmp298,
                     tmp23, tmp24, 0, kScale, tmp301);
  ...
  uint64_t *tmp305 =
      make_array<uint64_t>(1, 56, 56, 64);
  Relu4(1, 56, 56, 64, tmp301, tmp305,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,64,3,3,64,1,1,1,1,1,1,tmp305,tmp27,noise_cts_27,noise_pts_27,secret_share_vec_27,tmp27_pts,tmp307);
	}
  ...
  uint64_t *tmp310 =
      make_array<uint64_t>(1, 56, 56, 64);
  ScaleDown4(1, 56, 56, 64, tmp307,
             12);
  FusedBatchNorm4411(1, 56, 56, 64, tmp307,
                     tmp28, tmp29, 0, kScale, tmp310);
  ...
  uint64_t *tmp314 =
      make_array<uint64_t>(1, 56, 56, 64);
  Relu4(1, 56, 56, 64, tmp310, tmp314,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,64,1,1,256,0,0,0,0,1,1,tmp314,tmp32,noise_cts_32,noise_pts_32,secret_share_vec_32,tmp32_pts,tmp316);
	}
  ...
  uint64_t *tmp319 =
      make_array<uint64_t>(1, 56, 56, 256);
  ScaleUp4(1, 56, 56, 256, tmp290,
           12);
  MatAdd4(1, 56, 56, 256, tmp316, tmp290,
          tmp319);
  ...
  uint64_t *tmp322 =
      make_array<uint64_t>(1, 56, 56, 256);
  ScaleDown4(1, 56, 56, 256, tmp319,
             12);
  FusedBatchNorm4411(1, 56, 56, 256, tmp319,
                     tmp33, tmp34, 0, kScale, tmp322);
  ClearMemSecret1(256, tmp34);
  ClearMemSecret1(256, tmp33);

  uint64_t *tmp325 =
      make_array<uint64_t>(1, 56, 56, 256);
  Relu4(1, 56, 56, 256, tmp322, tmp325,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,256,1,1,64,0,0,0,0,1,1,tmp325,tmp37,noise_cts_37,noise_pts_37,secret_share_vec_37,tmp37_pts,tmp327);
	}
  ...
  uint64_t *tmp330 =
      make_array<uint64_t>(1, 56, 56, 64);
  ScaleDown4(1, 56, 56, 64, tmp327,
             12);
  FusedBatchNorm4411(1, 56, 56, 64, tmp327,
                     tmp38, tmp39, 0, kScale, tmp330);
  ...
  uint64_t *tmp334 =
      make_array<uint64_t>(1, 56, 56, 64);
  Relu4(1, 56, 56, 64, tmp330, tmp334,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,64,3,3,64,1,1,1,1,1,1,tmp334,tmp42,noise_cts_42,noise_pts_42,secret_share_vec_42,tmp42_pts,tmp336);
	}
  ...
  uint64_t *tmp339 =
      make_array<uint64_t>(1, 56, 56, 64);
  ScaleDown4(1, 56, 56, 64, tmp336,
             12);
  FusedBatchNorm4411(1, 56, 56, 64, tmp336,
                     tmp43, tmp44, 0, kScale, tmp339);
  ...
  uint64_t *tmp343 =
      make_array<uint64_t>(1, 56, 56, 64);
  Relu4(1, 56, 56, 64, tmp339, tmp343,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,64,1,1,256,0,0,0,0,1,1,tmp343,tmp47,noise_cts_47,noise_pts_47,secret_share_vec_47,tmp47_pts,tmp345);
	}
  ...
  uint64_t *tmp348 =
      make_array<uint64_t>(1, 56, 56, 256);
  ScaleUp4(1, 56, 56, 256, tmp319,
           12);
  MatAdd4(1, 56, 56, 256, tmp345, tmp319,
          tmp348);
  ...
  uint64_t *tmp351 =
      make_array<uint64_t>(1, 56, 56, 256);
  ScaleDown4(1, 56, 56, 256, tmp348,
             12);
  FusedBatchNorm4411(1, 56, 56, 256, tmp348,
                     tmp48, tmp49, 0, kScale, tmp351);
  ...
  uint64_t *tmp355 =
      make_array<uint64_t>(1, 56, 56, 256);
  Relu4(1, 56, 56, 256, tmp351, tmp355,
        kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 256, tmp351);

  int64_t *tmp357 = make_array<int64_t>(4, 2);
  Arr2DIdxRowM(tmp357, 4, 2, (int64_t)0, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp357, 4, 2, (int64_t)0, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp357, 4, 2, (int64_t)1, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp357, 4, 2, (int64_t)1, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp357, 4, 2, (int64_t)2, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp357, 4, 2, (int64_t)2, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp357, 4, 2, (int64_t)3, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp357, 4, 2, (int64_t)3, (int64_t)1) =
      0;

  uint64_t *tmp358 =
      make_array<uint64_t>(1, 56, 56, 256);
  Pad442(1, 56, 56, 256, 1,
         56, 56, 256, tmp355, 4, 2,
         tmp357, tmp358);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,56,56,256,1,1,512,0,0,0,0,2,2,tmp358,tmp52,noise_cts_52,noise_pts_52,secret_share_vec_52,tmp52_pts,tmp360);
	}
  ClearMemSecret4(1, 1, 256, 512, tmp52);
  ClearMemSecret4(1, 56, 56, 256, tmp358);

  uint64_t *tmp363 =
      make_array<uint64_t>(1, 56, 56, 128);
  if (!use_seconnds) {
		Conv2DWrapper(1,56,56,256,1,1,128,0,0,0,0,1,1,tmp355,tmp53,tmp363);
	} else {
		ConvOnlineHeliks(conv_ntt,1,56,56,256,1,1,128,0,0,0,0,1,1,tmp355,tmp53,noise_cts_53,noise_pts_53,secret_share_vec_53,tmp53_pts,tmp363);
	}
  ...
  uint64_t *tmp366 =
      make_array<uint64_t>(1, 56, 56, 128);
  ScaleDown4(1, 56, 56, 128, tmp363,
             12);
  FusedBatchNorm4411(1, 56, 56, 128, tmp363,
                     tmp54, tmp55, 0, kScale, tmp366);
  ...
  uint64_t *tmp370 =
      make_array<uint64_t>(1, 56, 56, 128);
  Relu4(1, 56, 56, 128, tmp366, tmp370,
        kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 56, 56, 128, tmp366);

  int64_t *tmp372 = make_array<int64_t>(4, 2);
  Arr2DIdxRowM(tmp372, 4, 2, (int64_t)0, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp372, 4, 2, (int64_t)0, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp372, 4, 2, (int64_t)1, (int64_t)0) =
      1;
  Arr2DIdxRowM(tmp372, 4, 2, (int64_t)1, (int64_t)1) =
      1;
  Arr2DIdxRowM(tmp372, 4, 2, (int64_t)2, (int64_t)0) =
      1;
  Arr2DIdxRowM(tmp372, 4, 2, (int64_t)2, (int64_t)1) =
      1;
  Arr2DIdxRowM(tmp372, 4, 2, (int64_t)3, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp372, 4, 2, (int64_t)3, (int64_t)1) =
      0;

  uint64_t *tmp373 =
      make_array<uint64_t>(1, 58, 58, 128);
  Pad442(1, 58, 58, 128, 1,
         56, 56, 128, tmp370, 4, 2,
         tmp372, tmp373);
  ClearMemPublic2(4, 2, tmp372);
  ClearMemSecret4(1, 56, 56, 128, tmp370);

  uint64_t *tmp376 =
      make_array<uint64_t>(1, 28, 28, 128);
  if (!use_seconnds) {
		Conv2DWrapper(1,58,58,128,3,3,128,0,0,0,0,2,2,tmp373,tmp58,tmp376);
	} else {
		ConvOnlineHeliks(conv_ntt,1,58,58,128,3,3,128,0,0,0,0,2,2,tmp373,tmp58,noise_cts_58,noise_pts_58,secret_share_vec_58,tmp58_pts,tmp376);
	}
  ...
  uint64_t *tmp379 =
      make_array<uint64_t>(1, 28, 28, 128);
  ScaleDown4(1, 28, 28, 128, tmp376,
             12);
  FusedBatchNorm4411(1, 28, 28, 128, tmp376,
                     tmp59, tmp60, 0, kScale, tmp379);
  ...
  uint64_t *tmp383 =
      make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp379, tmp383,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,128,1,1,512,0,0,0,0,1,1,tmp383,tmp63,noise_cts_63,noise_pts_63,secret_share_vec_63,tmp63_pts,tmp385);
	}
  ...
  uint64_t *tmp388 =
      make_array<uint64_t>(1, 28, 28, 512);
  MatAdd4(1, 28, 28, 512, tmp385, tmp360,
          tmp388);
  ...
  uint64_t *tmp391 =
      make_array<uint64_t>(1, 28, 28, 512);
  ScaleDown4(1, 28, 28, 512, tmp388,
             12);
  FusedBatchNorm4411(1, 28, 28, 512, tmp388,
                     tmp64, tmp65, 0, kScale, tmp391);
  ClearMemSecret1(512, tmp64);
  ClearMemSecret1(512, tmp65);

  uint64_t *tmp394 =
      make_array<uint64_t>(1, 28, 28, 512);
  Relu4(1, 28, 28, 512, tmp391, tmp394,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,512,1,1,128,0,0,0,0,1,1,tmp394,tmp68,noise_cts_68,noise_pts_68,secret_share_vec_68,tmp68_pts,tmp396);
	}
  ...
  uint64_t *tmp399 =
      make_array<uint64_t>(1, 28, 28, 128);
  ScaleDown4(1, 28, 28, 128, tmp396,
             12);
  FusedBatchNorm4411(1, 28, 28, 128, tmp396,
                     tmp69, tmp70, 0, kScale, tmp399);
  ...
  uint64_t *tmp403 =
      make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp399, tmp403,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,128,3,3,128,1,1,1,1,1,1,tmp403,tmp73,noise_cts_73,noise_pts_73,secret_share_vec_73,tmp73_pts,tmp405);
	}
  ...
  uint64_t *tmp408 =
      make_array<uint64_t>(1, 28, 28, 128);
  ScaleDown4(1, 28, 28, 128, tmp405,
             12);
  FusedBatchNorm4411(1, 28, 28, 128, tmp405,
                     tmp74, tmp75, 0, kScale, tmp408);
  ...
  uint64_t *tmp412 =
      make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp408, tmp412,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,128,1,1,512,0,0,0,0,1,1,tmp412,tmp78,noise_cts_78,noise_pts_78,secret_share_vec_78,tmp78_pts,tmp414);
	}
  ...
  uint64_t *tmp417 =
      make_array<uint64_t>(1, 28, 28, 512);
  ScaleUp4(1, 28, 28, 512, tmp388,
           12);
  MatAdd4(1, 28, 28, 512, tmp414, tmp388,
          tmp417);
  ...
  uint64_t *tmp420 =
      make_array<uint64_t>(1, 28, 28, 512);
  ScaleDown4(1, 28, 28, 512, tmp417,
             12);
  FusedBatchNorm4411(1, 28, 28, 512, tmp417,
                     tmp79, tmp80, 0, kScale, tmp420);
  ClearMemSecret1(512, tmp80);
  ClearMemSecret1(512, tmp79);

  uint64_t *tmp423 =
      make_array<uint64_t>(1, 28, 28, 512);
  Relu4(1, 28, 28, 512, tmp420, tmp423,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,512,1,1,128,0,0,0,0,1,1,tmp423,tmp83,noise_cts_83,noise_pts_83,secret_share_vec_83,tmp83_pts,tmp425);
	}
  ...
  uint64_t *tmp428 =
      make_array<uint64_t>(1, 28, 28, 128);
  ScaleDown4(1, 28, 28, 128, tmp425,
             12);
  FusedBatchNorm4411(1, 28, 28, 128, tmp425,
                     tmp84, tmp85, 0, kScale, tmp428);
  ...
  uint64_t *tmp432 =
      make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp428, tmp432,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,128,3,3,128,1,1,1,1,1,1,tmp432,tmp88,noise_cts_88,noise_pts_88,secret_share_vec_88,tmp88_pts,tmp434);
	}
  ...
  uint64_t *tmp437 =
      make_array<uint64_t>(1, 28, 28, 128);
  ScaleDown4(1, 28, 28, 128, tmp434,
             12);
  FusedBatchNorm4411(1, 28, 28, 128, tmp434,
                     tmp89, tmp90, 0, kScale, tmp437);
  ...
  uint64_t *tmp441 =
      make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp437, tmp441,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,128,1,1,512,0,0,0,0,1,1,tmp441,tmp93,noise_cts_93,noise_pts_93,secret_share_vec_93,tmp93_pts,tmp443);
	}
  ...
  uint64_t *tmp446 =
      make_array<uint64_t>(1, 28, 28, 512);
  ScaleUp4(1, 28, 28, 512, tmp417,
           12);
  MatAdd4(1, 28, 28, 512, tmp443, tmp417,
          tmp446);
  ...
  uint64_t *tmp449 =
      make_array<uint64_t>(1, 28, 28, 512);
  ScaleDown4(1, 28, 28, 512, tmp446,
             12);
  FusedBatchNorm4411(1, 28, 28, 512, tmp446,
                     tmp94, tmp95, 0, kScale, tmp449);
  ClearMemSecret1(512, tmp95);
  ClearMemSecret1(512, tmp94);

  uint64_t *tmp452 =
      make_array<uint64_t>(1, 28, 28, 512);
  Relu4(1, 28, 28, 512, tmp449, tmp452,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,512,1,1,128,0,0,0,0,1,1,tmp452,tmp98,noise_cts_98,noise_pts_98,secret_share_vec_98,tmp98_pts,tmp454);
	}
  ...
  uint64_t *tmp457 =
      make_array<uint64_t>(1, 28, 28, 128);
  ScaleDown4(1, 28, 28, 128, tmp454,
             12);
  FusedBatchNorm4411(1, 28, 28, 128, tmp454,
                     tmp99, tmp100, 0, kScale, tmp457);
  ...
  uint64_t *tmp461 =
      make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp457, tmp461,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,128,3,3,128,1,1,1,1,1,1,tmp461,tmp103,noise_cts_103,noise_pts_103,secret_share_vec_103,tmp103_pts,tmp463);
	}
  ...
  uint64_t *tmp466 =
      make_array<uint64_t>(1, 28, 28, 128);
  ScaleDown4(1, 28, 28, 128, tmp463,
             12);
  FusedBatchNorm4411(1, 28, 28, 128, tmp463,
                     tmp104, tmp105, 0, kScale, tmp466);
  ...
  uint64_t *tmp470 =
      make_array<uint64_t>(1, 28, 28, 128);
  Relu4(1, 28, 28, 128, tmp466, tmp470,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,128,1,1,512,0,0,0,0,1,1,tmp470,tmp108,noise_cts_108,noise_pts_108,secret_share_vec_108,tmp108_pts,tmp472);
	}
  ...
  uint64_t *tmp475 =
      make_array<uint64_t>(1, 28, 28, 512);
  ScaleUp4(1, 28, 28, 512, tmp446,
           12);
  MatAdd4(1, 28, 28, 512, tmp472, tmp446,
          tmp475);
  ...
  uint64_t *tmp478 =
      make_array<uint64_t>(1, 28, 28, 512);
  ScaleDown4(1, 28, 28, 512, tmp475,
             12);
  FusedBatchNorm4411(1, 28, 28, 512, tmp475,
                     tmp109, tmp110, 0, kScale, tmp478);
  ...
  uint64_t *tmp482 =
      make_array<uint64_t>(1, 28, 28, 512);
  Relu4(1, 28, 28, 512, tmp478, tmp482,
        kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 512, tmp478);

  int64_t *tmp484 = make_array<int64_t>(4, 2);
  Arr2DIdxRowM(tmp484, 4, 2, (int64_t)0, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp484, 4, 2, (int64_t)0, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp484, 4, 2, (int64_t)1, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp484, 4, 2, (int64_t)1, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp484, 4, 2, (int64_t)2, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp484, 4, 2, (int64_t)2, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp484, 4, 2, (int64_t)3, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp484, 4, 2, (int64_t)3, (int64_t)1) =
      0;

  uint64_t *tmp485 =
      make_array<uint64_t>(1, 28, 28, 512);
  Pad442(1, 28, 28, 512, 1,
         28, 28, 512, tmp482, 4, 2,
         tmp484, tmp485);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,28,28,512,1,1,1024,0,0,0,0,2,2,tmp485,tmp113,noise_cts_113,noise_pts_113,secret_share_vec_113,tmp113_pts,tmp487);
	}
  ClearMemSecret4(1, 1, 512, 1024, tmp113);
  ClearMemSecret4(1, 28, 28, 512, tmp485);

  uint64_t *tmp490 =
      make_array<uint64_t>(1, 28, 28, 256);
  if (!use_seconnds) {
		Conv2DWrapper(1,28,28,512,1,1,256,0,0,0,0,1,1,tmp482,tmp114,tmp490);
	} else {
		ConvOnlineHeliks(conv_ntt,1,28,28,512,1,1,256,0,0,0,0,1,1,tmp482,tmp114,noise_cts_114,noise_pts_114,secret_share_vec_114,tmp114_pts,tmp490);
	}
  ...
  uint64_t *tmp493 =
      make_array<uint64_t>(1, 28, 28, 256);
  ScaleDown4(1, 28, 28, 256, tmp490,
             12);
  FusedBatchNorm4411(1, 28, 28, 256, tmp490,
                     tmp115, tmp116, 0, kScale, tmp493);
  ...
  uint64_t *tmp497 =
      make_array<uint64_t>(1, 28, 28, 256);
  Relu4(1, 28, 28, 256, tmp493, tmp497,
        kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 28, 28, 256, tmp493);

  int64_t *tmp499 = make_array<int64_t>(4, 2);
  Arr2DIdxRowM(tmp499, 4, 2, (int64_t)0, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp499, 4, 2, (int64_t)0, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp499, 4, 2, (int64_t)1, (int64_t)0) =
      1;
  Arr2DIdxRowM(tmp499, 4, 2, (int64_t)1, (int64_t)1) =
      1;
  Arr2DIdxRowM(tmp499, 4, 2, (int64_t)2, (int64_t)0) =
      1;
  Arr2DIdxRowM(tmp499, 4, 2, (int64_t)2, (int64_t)1) =
      1;
  Arr2DIdxRowM(tmp499, 4, 2, (int64_t)3, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp499, 4, 2, (int64_t)3, (int64_t)1) =
      0;

  uint64_t *tmp500 =
      make_array<uint64_t>(1, 30, 30, 256);
  Pad442(1, 30, 30, 256, 1,
         28, 28, 256, tmp497, 4, 2,
         tmp499, tmp500);
  ClearMemPublic2(4, 2, tmp499);
  ClearMemSecret4(1, 28, 28, 256, tmp497);

  uint64_t *tmp503 =
      make_array<uint64_t>(1, 14, 14, 256);
  if (!use_seconnds) {
		Conv2DWrapper(1,30,30,256,3,3,256,0,0,0,0,2,2,tmp500,tmp119,tmp503);
	} else {
		ConvOnlineHeliks(conv_ntt,1,30,30,256,3,3,256,0,0,0,0,2,2,tmp500,tmp119,noise_cts_119,noise_pts_119,secret_share_vec_119,tmp119_pts,tmp503);
	}
  ...
  uint64_t *tmp506 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp503,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp503,
                     tmp120, tmp121, 0, kScale, tmp506);
  ...
  uint64_t *tmp510 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp506, tmp510,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,1,1,1024,0,0,0,0,1,1,tmp510,tmp124,noise_cts_124,noise_pts_124,secret_share_vec_124,tmp124_pts,tmp512);
	}
  ...
  uint64_t *tmp515 =
      make_array<uint64_t>(1, 14, 14, 1024);
  MatAdd4(1, 14, 14, 1024, tmp512, tmp487,
          tmp515);
  ...
  uint64_t *tmp518 =
      make_array<uint64_t>(1, 14, 14, 1024);
  ScaleDown4(1, 14, 14, 1024, tmp515,
             12);
  FusedBatchNorm4411(1, 14, 14, 1024,
                     tmp515, tmp125, tmp126, 0, kScale, tmp518);
  ClearMemSecret1(1024, tmp126);
  ClearMemSecret1(1024, tmp125);

  uint64_t *tmp521 =
      make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp518, tmp521,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,1024,1,1,256,0,0,0,0,1,1,tmp521,tmp129,noise_cts_129,noise_pts_129,secret_share_vec_129,tmp129_pts,tmp523);
	}
  ...
  uint64_t *tmp526 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp523,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp523,
                     tmp130, tmp131, 0, kScale, tmp526);
  ...
  uint64_t *tmp530 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp526, tmp530,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,3,3,256,1,1,1,1,1,1,tmp530,tmp134,noise_cts_134,noise_pts_134,secret_share_vec_134,tmp134_pts,tmp532);
	}
  ...
  uint64_t *tmp535 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp532,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp532,
                     tmp135, tmp136, 0, kScale, tmp535);
  ...
  uint64_t *tmp539 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp535, tmp539,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,1,1,1024,0,0,0,0,1,1,tmp539,tmp139,noise_cts_139,noise_pts_139,secret_share_vec_139,tmp139_pts,tmp541);
	}
  ...
  uint64_t *tmp544 =
      make_array<uint64_t>(1, 14, 14, 1024);
  ScaleUp4(1, 14, 14, 1024, tmp515,
           12);
  MatAdd4(1, 14, 14, 1024, tmp541, tmp515,
          tmp544);
  ...
  uint64_t *tmp547 =
      make_array<uint64_t>(1, 14, 14, 1024);
  ScaleDown4(1, 14, 14, 1024, tmp544,
             12);
  FusedBatchNorm4411(1, 14, 14, 1024,
                     tmp544, tmp140, tmp141, 0, kScale, tmp547);
  ClearMemSecret1(1024, tmp141);
  ClearMemSecret1(1024, tmp140);

  uint64_t *tmp550 =
      make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp547, tmp550,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,1024,1,1,256,0,0,0,0,1,1,tmp550,tmp144,noise_cts_144,noise_pts_144,secret_share_vec_144,tmp144_pts,tmp552);
	}
  ...
  uint64_t *tmp555 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp552,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp552,
                     tmp145, tmp146, 0, kScale, tmp555);
  ...
  uint64_t *tmp559 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp555, tmp559,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,3,3,256,1,1,1,1,1,1,tmp559,tmp149,noise_cts_149,noise_pts_149,secret_share_vec_149,tmp149_pts,tmp561);
	}
  ...
  uint64_t *tmp564 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp561,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp561,
                     tmp150, tmp151, 0, kScale, tmp564);
  ...
  uint64_t *tmp568 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp564, tmp568,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,1,1,1024,0,0,0,0,1,1,tmp568,tmp154,noise_cts_154,noise_pts_154,secret_share_vec_154,tmp154_pts,tmp570);
	}
  ...
  uint64_t *tmp573 =
      make_array<uint64_t>(1, 14, 14, 1024);
  ScaleUp4(1, 14, 14, 1024, tmp544,
           12);
  MatAdd4(1, 14, 14, 1024, tmp570, tmp544,
          tmp573);
  ...
  uint64_t *tmp576 =
      make_array<uint64_t>(1, 14, 14, 1024);
  ScaleDown4(1, 14, 14, 1024, tmp573,
             12);
  FusedBatchNorm4411(1, 14, 14, 1024,
                     tmp573, tmp155, tmp156, 0, kScale, tmp576);
  ClearMemSecret1(1024, tmp156);
  ClearMemSecret1(1024, tmp155);

  uint64_t *tmp579 =
      make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp576, tmp579,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,1024,1,1,256,0,0,0,0,1,1,tmp579,tmp159,noise_cts_159,noise_pts_159,secret_share_vec_159,tmp159_pts,tmp581);
	}
  ...
  uint64_t *tmp584 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp581,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp581,
                     tmp160, tmp161, 0, kScale, tmp584);
  ...
  uint64_t *tmp588 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp584, tmp588,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,3,3,256,1,1,1,1,1,1,tmp588,tmp164,noise_cts_164,noise_pts_164,secret_share_vec_164,tmp164_pts,tmp590);
	}
  ...
  uint64_t *tmp593 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp590,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp590,
                     tmp165, tmp166, 0, kScale, tmp593);
  ...
  uint64_t *tmp597 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp593, tmp597,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,1,1,1024,0,0,0,0,1,1,tmp597,tmp169,noise_cts_169,noise_pts_169,secret_share_vec_169,tmp169_pts,tmp599);
	}
  ...
  FusedBatchNorm4411(1, 14, 14, 1024,
                     tmp602, tmp170, tmp171, 0, kScale, tmp605);
  ClearMemSecret1(1024, tmp171);
  ClearMemSecret1(1024, tmp170);

  uint64_t *tmp608 =
      make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp605, tmp608,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,1024,1,1,256,0,0,0,0,1,1,tmp608,tmp174,noise_cts_174,noise_pts_174,secret_share_vec_174,tmp174_pts,tmp610);
	}
  ...
  uint64_t *tmp613 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp610,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp610,
                     tmp175, tmp176, 0, kScale, tmp613);
  ...
  uint64_t *tmp617 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp613, tmp617,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,3,3,256,1,1,1,1,1,1,tmp617,tmp179,noise_cts_179,noise_pts_179,secret_share_vec_179,tmp179_pts,tmp619);
	}
  ...
  uint64_t *tmp622 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp619,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp619,
                     tmp180, tmp181, 0, kScale, tmp622);
  ...
  uint64_t *tmp626 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp622, tmp626,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,1,1,1024,0,0,0,0,1,1,tmp626,tmp184,noise_cts_184,noise_pts_184,secret_share_vec_184,tmp184_pts,tmp628);
	}
  ...
  uint64_t *tmp631 =
      make_array<uint64_t>(1, 14, 14, 1024);
  ScaleUp4(1, 14, 14, 1024, tmp602,
           12);
  MatAdd4(1, 14, 14, 1024, tmp628, tmp602,
          tmp631);
  ...
  uint64_t *tmp634 =
      make_array<uint64_t>(1, 14, 14, 1024);
  ScaleDown4(1, 14, 14, 1024, tmp631,
             12);
  FusedBatchNorm4411(1, 14, 14, 1024,
                     tmp631, tmp185, tmp186, 0, kScale, tmp634);
  ClearMemSecret1(1024, tmp186);
  ClearMemSecret1(1024, tmp185);

  uint64_t *tmp637 =
      make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp634, tmp637,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,1024,1,1,256,0,0,0,0,1,1,tmp637,tmp189,noise_cts_189,noise_pts_189,secret_share_vec_189,tmp189_pts,tmp639);
	}
  ...
  uint64_t *tmp642 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp639,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp639,
                     tmp190, tmp191, 0, kScale, tmp642);
  ...
  uint64_t *tmp646 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp642, tmp646,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,3,3,256,1,1,1,1,1,1,tmp646,tmp194,noise_cts_194,noise_pts_194,secret_share_vec_194,tmp194_pts,tmp648);
	}
  ...
  uint64_t *tmp651 =
      make_array<uint64_t>(1, 14, 14, 256);
  ScaleDown4(1, 14, 14, 256, tmp648,
             12);
  FusedBatchNorm4411(1, 14, 14, 256, tmp648,
                     tmp195, tmp196, 0, kScale, tmp651);
  ...
  uint64_t *tmp655 =
      make_array<uint64_t>(1, 14, 14, 256);
  Relu4(1, 14, 14, 256, tmp651, tmp655,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,14,14,256,1,1,1024,0,0,0,0,1,1,tmp655,tmp199,noise_cts_199,noise_pts_199,secret_share_vec_199,tmp199_pts,tmp657);
	}
  ...
  uint64_t *tmp660 =
      make_array<uint64_t>(1, 14, 14, 1024);
  ScaleUp4(1, 14, 14, 1024, tmp631,
           12);
  MatAdd4(1, 14, 14, 1024, tmp657, tmp631,
          tmp660);
  ...
  uint64_t *tmp663 =
      make_array<uint64_t>(1, 14, 14, 1024);
  ScaleDown4(1, 14, 14, 1024, tmp660,
             12);
  FusedBatchNorm4411(1, 14, 14, 1024,
                     tmp660, tmp200, tmp201, 0, kScale, tmp663);
  ...
  uint64_t *tmp667 =
      make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp663, tmp667,
        kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 1024, tmp663);

  int64_t *tmp669 = make_array<int64_t>(4, 2);
  Arr2DIdxRowM(tmp669, 4, 2, (int64_t)0, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp669, 4, 2, (int64_t)0, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp669, 4, 2, (int64_t)1, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp669, 4, 2, (int64_t)1, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp669, 4, 2, (int64_t)2, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp669, 4, 2, (int64_t)2, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp669, 4, 2, (int64_t)3, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp669, 4, 2, (int64_t)3, (int64_t)1) =
      0;

  uint64_t *tmp670 =
      make_array<uint64_t>(1, 14, 14, 1024);
  Pad442(1, 14, 14, 1024, 1,
         14, 14, 1024, tmp667, 4,
         2, tmp669, tmp670);
  ClearMemPublic2(4, 2, tmp669);

  uint64_t *tmp672 =
      make_array<uint64_t>(1, 7, 7, 2048);
  if (!use_seconnds) {
		Conv2DWrapper(1,14,14,1024,1,1,2048,0,0,0,0,2,2,tmp670,tmp204,tmp672);
	} else {
		ConvOnlineHeliks(conv_ntt,1,14,14,1024,1,1,2048,0,0,0,0,2,2,tmp670,tmp204,noise_cts_204,noise_pts_204,secret_share_vec_204,tmp204_pts,tmp672);
	}
  ClearMemSecret4(1, 14, 14, 1024, tmp670);
  ClearMemSecret4(1, 1, 1024, 2048, tmp204);

  uint64_t *tmp675 =
      make_array<uint64_t>(1, 14, 14, 512);
  if (!use_seconnds) {
		Conv2DWrapper(1,14,14,1024,1,1,512,0,0,0,0,1,1,tmp667,tmp205,tmp675);
	} else {
		ConvOnlineHeliks(conv_ntt,1,14,14,1024,1,1,512,0,0,0,0,1,1,tmp667,tmp205,noise_cts_205,noise_pts_205,secret_share_vec_205,tmp205_pts,tmp675);
	}
  ...
  uint64_t *tmp678 =
      make_array<uint64_t>(1, 14, 14, 512);
  ScaleDown4(1, 14, 14, 512, tmp675,
             12);
  FusedBatchNorm4411(1, 14, 14, 512, tmp675,
                     tmp206, tmp207, 0, kScale, tmp678);
  ...
  uint64_t *tmp682 =
      make_array<uint64_t>(1, 14, 14, 512);
  Relu4(1, 14, 14, 512, tmp678, tmp682,
        kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 14, 14, 512, tmp678);

  int64_t *tmp684 = make_array<int64_t>(4, 2);
  Arr2DIdxRowM(tmp684, 4, 2, (int64_t)0, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp684, 4, 2, (int64_t)0, (int64_t)1) =
      0;
  Arr2DIdxRowM(tmp684, 4, 2, (int64_t)1, (int64_t)0) =
      1;
  Arr2DIdxRowM(tmp684, 4, 2, (int64_t)1, (int64_t)1) =
      1;
  Arr2DIdxRowM(tmp684, 4, 2, (int64_t)2, (int64_t)0) =
      1;
  Arr2DIdxRowM(tmp684, 4, 2, (int64_t)2, (int64_t)1) =
      1;
  Arr2DIdxRowM(tmp684, 4, 2, (int64_t)3, (int64_t)0) =
      0;
  Arr2DIdxRowM(tmp684, 4, 2, (int64_t)3, (int64_t)1) =
      0;

  uint64_t *tmp685 =
      make_array<uint64_t>(1, 16, 16, 512);
  Pad442(1, 16, 16, 512, 1,
         14, 14, 512, tmp682, 4, 2,
         tmp684, tmp685);
  ClearMemPublic2(4, 2, tmp684);
  ClearMemSecret4(1, 14, 14, 512, tmp682);

  uint64_t *tmp688 =
      make_array<uint64_t>(1, 7, 7, 512);
  if (!use_seconnds) {
		Conv2DWrapper(1,16,16,512,3,3,512,0,0,0,0,2,2,tmp685,tmp210,tmp688);
	} else {
		ConvOnlineHeliks(conv_ntt,1,16,16,512,3,3,512,0,0,0,0,2,2,tmp685,tmp210,noise_cts_210,noise_pts_210,secret_share_vec_210,tmp210_pts,tmp688);
	}
  ...
  uint64_t *tmp691 =
      make_array<uint64_t>(1, 7, 7, 512);
  ScaleDown4(1, 7, 7, 512, tmp688,
             12);
  FusedBatchNorm4411(1, 7, 7, 512, tmp688,
                     tmp211, tmp212, 0, kScale, tmp691);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,7,7,512,1,1,2048,0,0,0,0,1,1,tmp695,tmp215,noise_cts_215,noise_pts_215,secret_share_vec_215,tmp215_pts,tmp697);
	}
  ...
  uint64_t *tmp700 =
      make_array<uint64_t>(1, 7, 7, 2048);
  MatAdd4(1, 7, 7, 2048, tmp697, tmp672,
          tmp700);
  ...
  uint64_t *tmp703 =
      make_array<uint64_t>(1, 7, 7, 2048);
  ScaleDown4(1, 7, 7, 2048, tmp700,
             12);
  FusedBatchNorm4411(1, 7, 7, 2048, tmp700,
                     tmp216, tmp217, 0, kScale, tmp703);
  ClearMemSecret1(2048, tmp217);
  ClearMemSecret1(2048, tmp216);

  uint64_t *tmp706 =
      make_array<uint64_t>(1, 7, 7, 2048);
  Relu4(1, 7, 7, 2048, tmp703, tmp706,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,7,7,2048,1,1,512,0,0,0,0,1,1,tmp706,tmp220,noise_cts_220,noise_pts_220,secret_share_vec_220,tmp220_pts,tmp708);
	}
  ...
  uint64_t *tmp711 =
      make_array<uint64_t>(1, 7, 7, 512);
  ScaleDown4(1, 7, 7, 512, tmp708,
             12);
  FusedBatchNorm4411(1, 7, 7, 512, tmp708,
                     tmp221, tmp222, 0, kScale, tmp711);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,7,7,512,3,3,512,1,1,1,1,1,1,tmp715,tmp225,noise_cts_225,noise_pts_225,secret_share_vec_225,tmp225_pts,tmp717);
	}
  ...
  uint64_t *tmp720 =
      make_array<uint64_t>(1, 7, 7, 512);
  ScaleDown4(1, 7, 7, 512, tmp717,
             12);
  FusedBatchNorm4411(1, 7, 7, 512, tmp717,
                     tmp226, tmp227, 0, kScale, tmp720);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,7,7,512,1,1,2048,0,0,0,0,1,1,tmp724,tmp230,noise_cts_230,noise_pts_230,secret_share_vec_230,tmp230_pts,tmp726);
	}
  ...
  uint64_t *tmp729 =
      make_array<uint64_t>(1, 7, 7, 2048);
  ScaleUp4(1, 7, 7, 2048, tmp700,
           12);
  MatAdd4(1, 7, 7, 2048, tmp726, tmp700,
          tmp729);
  ...
  uint64_t *tmp732 =
      make_array<uint64_t>(1, 7, 7, 2048);
  ScaleDown4(1, 7, 7, 2048, tmp729,
             12);
  FusedBatchNorm4411(1, 7, 7, 2048, tmp729,
                     tmp231, tmp232, 0, kScale, tmp732);
  ClearMemSecret1(2048, tmp231);
  ClearMemSecret1(2048, tmp232);

  uint64_t *tmp735 =
      make_array<uint64_t>(1, 7, 7, 2048);
  Relu4(1, 7, 7, 2048, tmp732, tmp735,
        kScale, kDoExtractTruncate);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,7,7,2048,1,1,512,0,0,0,0,1,1,tmp735,tmp235,noise_cts_235,noise_pts_235,secret_share_vec_235,tmp235_pts,tmp737);
	}
  ...
  uint64_t *tmp740 =
      make_array<uint64_t>(1, 7, 7, 512);
  ScaleDown4(1, 7, 7, 512, tmp737,
             12);
  FusedBatchNorm4411(1, 7, 7, 512, tmp737,
                     tmp236, tmp237, 0, kScale, tmp740);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,7,7,512,3,3,512,1,1,1,1,1,1,tmp744,tmp240,noise_cts_240,noise_pts_240,secret_share_vec_240,tmp240_pts,tmp746);
	}
  ...
  uint64_t *tmp749 =
      make_array<uint64_t>(1, 7, 7, 512);
  ScaleDown4(1, 7, 7, 512, tmp746,
             12);
  FusedBatchNorm4411(1, 7, 7, 512, tmp746,
                     tmp241, tmp242, 0, kScale, tmp749);
  ...
  if (!use_seconnds) {
		...
		ConvOnlineHeliks(conv_ntt,1,7,7,512,1,1,2048,0,0,0,0,1,1,tmp753,tmp245,noise_cts_245,noise_pts_245,secret_share_vec_245,tmp245_pts,tmp755);
	}
  ...
  FusedBatchNorm4411(1, 7, 7, 2048, tmp758,
                     tmp246, tmp247, 0, kScale, tmp761);
  ...
  uint64_t *tmp765 =
      make_array<uint64_t>(1, 7, 7, 2048);
  Relu4(1, 7, 7, 2048, tmp761, tmp765,
        kScale, kDoExtractTruncate);
  ClearMemSecret4(1, 7, 7, 2048, tmp761);

  uint64_t *tmp767 =
      make_array<uint64_t>(1, 1, 1, 2048);
  AvgPool(1, 1, 1, 2048, 7,
          7, 0, 0, 0, 0,
          1, 1, 1, 7, 7,
          2048, tmp765, tmp767);
  ...
  int64_t tmp770 = 2;
  Squeeze24(1, 2048, tmp769, tmp770, 1, 1,
            1, 2048, tmp767, tmp771);
