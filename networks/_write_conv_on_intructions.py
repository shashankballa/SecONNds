...
def process_conv_block(block):
    ...
    if matches:
        for match in matches:
            ...
            # Construct the ConvOnlineCheetah block, ensuring the first tmp argument is included
            conv_cheetah = f"""ConvOnlineCheetah({part1}tmp{num1},tmp{num2},tmp{num2}_pts,{part4});"""
